...
exports.methods_list = function() {
    ...
    list += "                    ╠═════════╦════════════════════╦═════════╣\r\n";
    list += "                    ║  " + config.Colors.Yellow + "API 1" + config.Colors.Red + "  ║                    ║  " + config.Colors.Yellow + "API 2" + config.Colors.Red + "  ║\r\n";
    list += "                    ╠═════════╩════════╗    ╔══════╩═════════╣\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "LDAP" + config.Colors.Red + "           ║    ║ → " + config.Colors.Yellow + "HOME-DROPER" + config.Colors.Red + "  ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "VSE" + config.Colors.Red + "            ║    ║ → " + config.Colors.Yellow + "killhomes" + config.Colors.Red + "    ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "UDP-DROP" + config.Colors.Red + "       ║    ║ → " + config.Colors.Yellow + "NTP-HOME" + config.Colors.Red + "     ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "DNS" + config.Colors.Red + "            ║    ║ → " + config.Colors.Yellow + "FIVEM" + config.Colors.Red + "        ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "R6-DROP" + config.Colors.Red + "        ║    ║ → " + config.Colors.Yellow + "MW-SLAP" + config.Colors.Red + "      ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "REDSYN-V2" + config.Colors.Red + "      ║    ║ → " + config.Colors.Yellow + "COLDWAR" + config.Colors.Red + "      ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "R6-LAG" + config.Colors.Red + "         ║    ║ → " + config.Colors.Yellow + "2k" + config.Colors.Red + "           ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "OVH-KILLERV3" + config.Colors.Red + "   ║    ║ → " + config.Colors.Yellow + "R6-RANK" + config.Colors.Red + "      ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "NFO-RIOT" + config.Colors.Red + "       ║    ║ → " + config.Colors.Yellow + "Apex" + config.Colors.Red + "         ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "NFO-COMPLEXITY" + config.Colors.Red + " ║    ║ → " + config.Colors.Yellow + "HYDRA-X" + config.Colors.Red + "      ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "GAME-OUT" + config.Colors.Red + "       ║    ║ → " + config.Colors.Yellow + "OVHDOWN" + config.Colors.Red + "      ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "HYDRA-RAPE" + config.Colors.Red + "     ║    ║ → " + config.Colors.Yellow + "NFO-LIFT" + config.Colors.Red + "     ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "OVH-BETA" + config.Colors.Red + "       ║    ║ → " + config.Colors.Yellow + "HYDRA-SLAP" + config.Colors.Red + "   ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "DEDIPATH-SAS" + config.Colors.Red + "   ║    ║ → " + config.Colors.Yellow + "killvpn1" + config.Colors.Red + "     ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "SERVERV2" + config.Colors.Red + "       ║    ║ → " + config.Colors.Yellow + "OVHGAME" + config.Colors.Red + "      ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "ZOOM-CRASH" + config.Colors.Red + "     ║    ║ → " + config.Colors.Yellow + "TCP-BYPASS" + config.Colors.Red + "   ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "FIVEM-LAG" + config.Colors.Red + "      ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "SYN-XV" + config.Colors.Red + "         ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "UDPBYPASS" + config.Colors.Red + "      ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "CLOUDFLARE-XV" + config.Colors.Red + "  ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "DDOSGUARD-ONYX" + config.Colors.Red + " ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "SUCURI-KILLER" + config.Colors.Red + "  ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "AUTODETECT-ONYX" + config.Colors.Red + "║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "GET-BYPASS" + config.Colors.Red + "     ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ║ → " + config.Colors.Yellow + "STORMWALL-ONYX" + config.Colors.Red + " ║    ║ → " + config.Colors.Yellow + "N/A" + config.Colors.Red + "          ║\r\n";
    list += "                    ╚══════════════════╝    ╚════════════════╝\r\n";
    return list;
}
